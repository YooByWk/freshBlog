...
@Module({
  ...
  injectables: [{ useClass: PostgresRepository, token: USER_REPOSITORY }, TodoService], // change InMemoryTodoRepository by any custom repository using other database engine if needed
